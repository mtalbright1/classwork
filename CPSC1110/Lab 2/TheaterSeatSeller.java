...
public class TheaterSeatSeller {
	...
	int[] pricesAvailable = {0,0,0,0,0,0}; //6 ticket prices, 10,20,30,40,50,60
	...
	int[][] seats = 
		{	{10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
			...
			{10, 10, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 10, 10},
			{10, 20, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 20, 10},
			{10, 20, 30, 30, 30, 40, 40, 40, 40, 30, 30, 30, 20, 10},
			{20, 20, 30, 30, 40, 40, 40, 40, 40, 40, 30, 30, 20, 20},
			{20, 30, 30, 40, 40, 40, 40, 40, 40, 40, 40, 30, 30, 20},
			{30, 30, 40, 50, 50, 50, 50, 50, 50, 50, 50, 40, 30, 30},
			{30, 40, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 40, 30},
			{40, 50, 50, 60, 60, 60, 60, 60, 60, 60, 60, 50, 50, 40}	};
	...
	public void printSeats() {
		...
		System.out.println("Number of seats of each price: ");
		for (int i = 0; i < pricesAvailable.length; i++) {
			System.out.println(((i + 1) * 10) + ": " + pricesAvailable[i]); 
		}
	}
	...
	public void start() { //initiates the simulation
		...
		while(running) {//main execution loop
			...
			if(userInput.charAt(0) == 'Q' || userInput.charAt(0) == 'q') {
				...
				System.out.print("Enter Price (10,20,30,40,50,60):");
				int price =0;
				userInput = myScanner.next();
				System.out.println();
				if(userInput.equals("10")||userInput.equals("20")||userInput.equals("30")
						||userInput.equals("40")||userInput.equals("50")||userInput.equals("60")) {
